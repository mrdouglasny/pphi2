...
| 34 | ~~`measure_determined_by_schwinger`~~ | Bridge | ✅ **PROVED** | DT 2026-02-24 | Discharged 2026-05-22 (`MeasureUniqueness.lean`, `measure_eq_of_moments`): finite exp-moment ⟹ entire MGF ⟹ equal moments give equal MGF (identity theorem) ⟹ equal 1D law; Cramér–Wold + Kolmogorov lift to the full measure. Depends only on `[propext, Classical.choice, Quot.sound]`. |
