...
/-- **AsymTorus generating-functional seminorm bound** (axiomatised in
Stage 1 — the proof uses lattice-covariance bounds and second-moment
plumbing whose cascade-fix from Option C is mechanical but tedious;
deferred to Phase 2). -/
