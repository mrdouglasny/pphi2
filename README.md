...
placeholders remain. Of the 38 axioms, 33 are required for the main theorem
and 5 are optional (an alternative "Option B" Gross-Rothaus-Simon proof path
for hypercontractivity). The 16 sorries are well-typed intermediate proof steps
connecting axioms to the OS properties.

- **pphi2:** 38 axioms (33 required + 5 optional), 16 sorries
