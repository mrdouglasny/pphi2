...
**19 axioms, 0 sorries** (pphi2; `count_axioms.sh` reports 21 axioms due to two `axiom`-prefixed words in docstrings; the rough_error_variance critical-path file is now fully proved modulo the two new Phase B textbook axioms introduced 2026-05-12) + **3 axioms, 0 sorries** (gaussian-field) + **4 axioms, 0 sorries** (gaussian-hilbert) + **11 axioms, 0 sorries** (markov-semigroups) = **37 axioms across the four active repos**. See [`docs/AXIOM_STATUS.md`](docs/AXIOM_STATUS.md) for the canonical inventory.
