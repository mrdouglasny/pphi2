...
**23 axioms, 0 sorries** (pphi2) + **5 axioms, 1 sorry** (gaussian-field) = **28 combined**.
Stage 1 lattice-action fix raised the count from 22 to 35; Phase 2
partial discharge plus PR #14 (Route B′ IR-limit refactor +
`fourierTransform_lp_eq_fourierIntegral` proof) brought it back to 28.
Five axioms discharged in Phase 2: `roughCovariance_sq_summable`,
