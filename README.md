...
**17 axioms, 2 sorries** (pphi2; `count_axioms.sh` reports 19 axioms due to two `axiom`-prefixed words in docstrings; the 2 sorries are S4 + S5 of the in-progress `rough_error_variance` chain in `RoughErrorBound.lean`) + **3 axioms, 0 sorries** (gaussian-field) + **4 axioms, 0 sorries** (gaussian-hilbert) + **11 axioms, 0 sorries** (markov-semigroups) = **35 axioms across the four active repos**. See [`docs/AXIOM_STATUS.md`](docs/AXIOM_STATUS.md) for the canonical inventory.
