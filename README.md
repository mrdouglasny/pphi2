...
**16 axioms, 0 sorries** in the active pphi2 build, plus **4 axioms,
0 sorries** in the pinned Lake `GaussianField` dependency, for **20 combined
axioms**.
