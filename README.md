...
1. **UV limit (DONE):** On the asymmetric torus T_{Lt,Ls} = (ℝ/Lt ℤ) × (ℝ/Ls ℤ)
   ...
   discharged 2026-05-23 — BC-limit lift of the proved cutoff exp-moment bound via truncation +
   MCT; `asymGf_sub_norm_le_seminorm` was discharged 2026-05-08 via
